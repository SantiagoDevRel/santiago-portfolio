  ...
  return (
    <div className="pt-24 pb-16 px-6 max-w-3xl mx-auto">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4 text-[#FF6B35]">Story</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4 text-[#FF6B35]">Stack</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4 text-[#FF6B35]">Philosophy</h2>
        <p className="text-foreground/70 leading-relaxed">
