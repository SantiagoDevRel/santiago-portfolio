...
export const career: CareerEntry[] = [
  ...
  },
  {
    ...
    description:
      "Senior Developer Relations for Arkiv, the Web3 database: an Ethereum-aligned DB-Chain where data lives as queryable, time-scoped entities. Building the AI-native onboarding path (MCP server, docs, telemetry), publishing the open-source tooling around the SDK, stress-testing the chain itself, running the builder programs (the Arkiv Ideathon and the ETHRome bounty), and turning what builders hit into engineering data.",
    metrics: [
      { label: "Ideathon submissions judged", value: "169" },
      { label: "ETHRome teams shipped on Arkiv", value: "13" },
      { label: "Builder feedback points verified", value: "286" },
      { label: "MCP servers shipped", value: "4" },
    ...
    category: "Current",
    bullets: [
      "Ran the Arkiv bounty at ETHRome 2026 (Rome): one canonical rule source generating the builder hub page, the MCP knowledge base and the submission form, a 20-minute Postgres to Arkiv workshop on SDK 0.8, and on-site judging. 13 teams shipped on the Tiramisu testnet over the weekend",
      "Shipped a read-only, keyless ETHRome MCP server that builders used as a rules checker: validate a schema, pre-check a submission, read the bounty. 204 builder calls in the event window with 2 technical errors in about 50 hours",
      "Turned hackathon feedback into engineering data: archived every feedback file pinned to the judged commit, and checked 286 builder claims about Arkiv against SDK source (133 confirmed, 51 partly true, 15 wrong) before they reached the engineering team",
      "Measured the SDK 0.8 surface against the live network before the event, catching 7 wrong assumptions in the plan, including a 10x error in block time that would have broken every expiration example",
      "Hosted and judged the Arkiv Ideathon (Aug 2026): built the landing, an idea-coach MCP server and the public results repo, and judged 169 submissions across the AI & DevTools and Other tracks",
      ...
      "Ran the product's live event surfaces: an interactive booth app for ETHPragma Lisbon where every tap exercises a real Arkiv capability against a live testnet, and the builder-facing ETHRome page on the official hub",
    ...
    partners: ["ETHGlobal", "ETHRome", "Sourcify", "ENS", "World", "Sui", "Walrus"],
    photos: [
      { filename: "arkiv1.jpg", alt: "SureX team at ETHGlobal Lisbon 2026", date: "Jul 2026" },
      { filename: "arkiv2.jpg", alt: "Arkiv team at the ETHRome 2026 booth", date: "Sep 2026" },
      { filename: "arkiv3.jpg", alt: "At the Arkiv booth, ETHRome 2026", date: "Sep 2026" },
    ],
    links: [
      { label: "Arkiv.network", url: "https://arkiv.network" },
      { label: "Arkiv Builder Hub", url: "https://hub.arkiv.network" },
      { label: "ETHRome bounty page", url: "https://hub.arkiv.network/ethrome" },
      { label: "Arkiv Ideathon results", url: "https://github.com/Arkiv-Network/arkiv-ideathon" },
